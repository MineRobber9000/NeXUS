...
-- by 25A0
-- licensed under Unlicense (upstream is https://github.com/25A0/blob)
-- modifications by minerobber licensed under CC0 (fallback to Unlicense)

local Blob = {}

-- use love's string packing functions (they have similar semantics to lua 5.3+
-- string.unpack and string.packsize, the only difference is love.data.pack has
-- an additional parameter)
local lib = {}
lib.size = love.data.getPackedSize
lib.unpack = love.data.unpack
lib.zerostring = "z"
